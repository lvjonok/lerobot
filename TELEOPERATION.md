...
The processor factory (`processor/factory.py`) auto-selects the correct processor for each `crisp_fastapi` + teleoperator combination:

| Teleoperator | Processor | Description |
|---|---|---|
